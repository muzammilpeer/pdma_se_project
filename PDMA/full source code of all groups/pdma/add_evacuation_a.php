  ...
  <tr>
    ...
    <td valign="top"><form id="form2" name="form2" method="post" action="add_evacuation2.php">
      ...
      <table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <th scope="col"><div align="left" class="WelcomeText"><br />
                    <span class="InsidePageHeading">Locations  Details</span><br />
                  <br />
				</div>
                <table width="448" border="0" cellpadding="0" cellspacing="4">
  <tr>
  <td width="148" class="Text">
    <div align="right">Province   </div></td>
    <td width="114">
		
		<div align="center">
		  <select name="list1" class="List" onchange="ajaxFunction('LBox2', this.value);">
		    <option value=''></option>
		        <?php 
    ...
    <td width="136"><select name="list2" class="List" id="LBox2">
    </select></td>
  </tr>
</table>
