...
<table width="545" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <th width="528" valign="middle" scope="col"><p><br />
    </p>
        <div align="left" class="WelcomeHeading">
          <div align="center">ADMIN DETAILS</div>
        </div>
		<?php include 'conn.php'; ?>
      <form id="form3" name="form3" method="post" action="search_person.php">
          <div align="left" class="WelcomeText"><br />
              <span class="InsidePageHeading">Enter Camp  Details </span><br />
              <br />
          </div>
        ...
        <table width="450" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <th width="82" scope="col"> <div align="left">
                  <input name="Submit2" type="submit" class="Login" value="Search"  action='add_evacuation2.php' />
              </div></th>
            </tr>
        </table>
      </form></th>
