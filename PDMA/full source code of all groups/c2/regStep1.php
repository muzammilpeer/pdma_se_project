...
<div align="center" class="VERDANA14" style="color:#FFFFFF; background-color:#000099; font-weight: bold;">Organization Registration : STEP 1</div>
<form name="regStep1" action="regStep2.php" method="POST">
    <fieldset><legend>Login Credentials</legend>
        <table width="100%" border="0">
            <tr bgcolor="#CCCCCC">
                <td width="32%"><label>User Name:</label></td>
                <td width="68%"><input name="userName" type="text" /></td>
            </tr>
            <tr bgcolor="#CCCCCC">
            ...
            <tr bgcolor="#CCCCCC">
                ...
                <td><input name="conPword" type="password" /></td>
            </tr>
        </table>
    ...
    <fieldset><legend>Primary Details</legend>
        <table width="100%" border="0">
            <tr bgcolor="#CCCCCC">
                ...
                <td><input name="organName" type="text" width="250%" /></td>
            </tr>
            <tr bgcolor="#CCCCCC">
                <td width="32%" align="right"><label>URL: </label></td>
                <td><input name="url" type="text" width="250%" /></td>
            </tr>
            <tr bgcolor="#CCCCCC">
            ...
            <tr bgcolor="#CCCCCC">
                ...
                <td valign="top">
                    <table width="100%" border="0">
                        <tr bgcolor="#CCCCCC">
                            <td><input name="supplier" type="checkbox" value="Supplier of Goods" />
    	      Supplier of Goods</td>
                            <td><input name="rehab" type="checkbox" value="Rehabilitation" />
    	      Rehabilitation </td>
                        </tr>
                        <tr bgcolor="#CCCCCC">
                            <td><input name="com" type="checkbox" value="Communication" />
    	      Communication</td>
                            <td><input name="edu" type="checkbox" value="Education" />
    	      Education</td>
                        </tr>
                        <tr bgcolor="#CCCCCC">
                            <td><input name="medical" type="checkbox" value="Medical Services" />
    	      Medical Services </td>
                            <td>&nbsp;</td>
                        </tr>
                    </table>
    ...
    <fieldset><legend>Base Location</legend>
        <table width="100%" border="0">
            <tr bgcolor="#CCCCCC">
                ...
                <td width="68%"><select name="district">
