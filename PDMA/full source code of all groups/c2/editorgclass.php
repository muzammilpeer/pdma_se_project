...
class EditOrg {
	...
	function Generate_Query($U, $OT, $SecS, $SecC, $SecEd, $SecReh, $SecM, $user) {
		...
		if ($SecSup) {
				$QueryStr .= " sec_supplier=1 " ;
			//	$check = true ;
		}
		else
		{
			$QueryStr .= " sec_supplier=0 " ;
		}
		
		if ($SecCom) {
			//if (!$check) {
			//	$QueryStr .= " sec_communication=1" ;
			//	$check = true ;
			//}
		//	else {
				$QueryStr .= ", sec_communication=1" ;
