...
?>
<div align="center" class="VERDANA14" style="color:#FFFFFF; background-color:#000099; font-weight: bold;">ADD BRANCH</div>
<form name="regStep3" action="addBranch.php" method="POST">
    <fieldset>
        <legend>Base Location</legend>
        <table width="100%" border="0">
            <?php echo "<input type='hidden' name='username' value='$_SESSION[user]' readonly='readonly' />" ?>
            <tr bgcolor="#CCCCCC">
    ...
    <fieldset>
        <legend>Contact Information
            ...
            <tr bgcolor="#CCCCCC">
                ...
                <td width="73%"><input name="" type="text" width="250%" /></td>
            </tr>
            <tr bgcolor="#CCCCCC">
    ...
    <fieldset>
        ...
        <table width="100%" border="0">
            ...
            <tr bgcolor="#CCCCCC">
                <td width="27%" align="right"><label>Other Relavent Information: </label></td>
                <td><input name="" type="text" width="250%" /></td>
            </tr>
        </table>
