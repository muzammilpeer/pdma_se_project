...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form id="form1" name="form1" method="post" action="mainhtml.php">
            ...
            <table width="799" align="center">
                <tr>
                    <td width="188" align="center" valign="top"><table width="185" border="1">
                            <tr>
                    ...
                    <td width="599" height="596" align="center" valign="top"><h1><strong><em>Saved Contacts</em></strong></h1>
                        <table width="523" height="34">
                            <tr>
                                <td width="127" align="center" bgcolor="#6600FF">Name</td>
                                <td width="124" align="center" bgcolor="#6600FF">Designtion</td>
                        ...
                        <p>
                            ...
                            while ($row=mysql_fetch_array($result)) {
                                echo  "<table width='523'>";

                                echo" <tr>";
                                echo"  <td width='127' bgcolor='silver' > ".$row['name']."</td>";
                                echo"  <td width='124' bgcolor='#CCCCCC'>".$row['design']."</td>";
