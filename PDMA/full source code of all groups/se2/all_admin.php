    ...
    <body>
        <form id="form1" name="form1" method="post" action="">
            ...
            <table width="799" align="center">
                <tr>
                    <td width="184" align="center" valign="top"><table width="185" border="1">
                            <tr>
                    ...
                    <td width="603" height="596" align="center" valign="top"><h1><strong><em>Admin Contacts</em></strong></h1>
                        ...
                        <p>
                            ...
                            $result=mysql_query("select * from contact where design='admin'");
